...
public class mydao {
    ...
    public void SearchByTimeAndLocation(String timein,String timeout,Object CenterPoint,Double LineLength){
        //es查询：时间段range{gte:timein,lt:timeout} And geo_distance {location:CenterPoint,distance:LineLength,distance_type:plane}
        /**
